  ...
  <body >
    <nav class="navbar navbar-expand-xl navbar-dark " >
      ...
      <div class="row row-cols-1 row-cols-md-2">
        <div class="col mb-4"> 
          <div class="card">
            <img src="../iclinic/imgs/cadastro_uti.jpeg" class="card-img-top" alt="...">
            <div class="card-body" >
              <h5 class="card-title">Cadastrar Paciente</h5>
              <p class="card-text">Adicionar o paciente a determinado leito.</p>
            </div>
            <div class="button">
        ...
        <div class="col mb-4">
          <div class="card">
            <img src="../iclinic/imgs/consulta_uti.jpeg" class="card-img-top" alt="...">
            <div class="card-body" >
              <h5 class="card-title">Consultar Leitos</h5>
              <p class="card-text">Apresenta a visualização organizada de cada leito da UTI.</p>
            </div>
            <div class="button">
      ...
      function cadastrar(){
        window.location.href="../iclinic/crud_leito_uti/adicionar_leito_uti.php";
      }
      function consultar(){
        window.location.href="../iclinic/crud_leito_uti/consultar_leito_uti.php";
      }
      </script>
