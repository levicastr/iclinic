...
class paciente extends Conexao{
    ...
    function adicionar_paciente($nome, $data_nascimento, $CPF, $RG, $nome_responsavel, $CPF_responsavel, $RG_responsavel,
    ...
    function editar_paciente($id, $nome, $data_nascimento, $CPF, $RG, $nome_responsavel, $CPF_responsavel, 
     $RG_responsavel, $endereco, $numero,  $bairro, $estado, $cidade, $telefone, $email, $senha ){
		$conexao = Conexao::conectar();
