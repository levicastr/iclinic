...
class marcar_consultas extends Conexao{
	...
	public function listar_marcar_consultas(){
		...
		while($valores = mysqli_fetch_assoc($resultado)){
			$marcar_consultas[] = $valores;
		}
		return $marcar_consultas;
	}
	
    function adicionar_marcar_consultas($nome, $data_nascimento, $CPF, $RG, $data_consulta, $tipo){
		$conexao = Conexao::conectar();
		...
		echo "
			<script type='text/javascript'>
				...
				window.location = 'consulta_marcar_consultas.php';
			</script>
		";
	}  
	...
	function editar_marcar_consultas($id, $nome, $data_nascimento, $CPF, $RG, $data_consulta, $tipo){
		...
		echo "
			<script type='text/javascript'>
				...
				window.location = 'consulta_marcar_consulta.php';
			</script>
		";
	}
