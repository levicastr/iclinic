  ...
  <body >
    <nav class="navbar navbar-expand-xl navbar-dark " >
      ...
      <div class="row row-cols-1 row-cols-md-2">
        <div class="col mb-4"> 
          <div class="card">
            <img src="../iclinic/imgs/cadastro_paciente.jpeg" class="card-img-top" alt="...">
            <div class="card-body" >
              <h5 class="card-title">Cadastrar Paciente</h5>
              <p class="card-text">Ao entrar na página de cadastro você pode adicionar um novo paciente no sistema.</p>
            </div>
            <div class="button">
        ...
        <div class="col mb-4">
          <div class="card">
            <img src="../iclinic/imgs/consulta_paciente.jpeg" class="card-img-top" alt="...">
            <div class="card-body" >
              <h5 class="card-title">Consultar Paciente</h5>
              <p class="card-text">Ao entrar na página de consulta o sistema mostrará a listagem de todos pacientes.</p>
            </div>
            <div class="button">
                <button  onclick="consultar()"  type="button" class="btn btn-success" id="consul">Consultar Paciente</button>
              </div>
          </div>
        </div>
      </div>
      ...
      function cadastrar(){
        window.location.href="../iclinic/crud_paciente/adicionar_paciente.php";
      }
      function consultar(){
        window.location.href="../iclinic/crud_paciente/consultar_paciente.php";
      }
      </script>
