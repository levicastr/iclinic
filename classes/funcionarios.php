...
class funcionarios extends Conexao{
    ...
    $bairro, $estado, $cidade, $telefone){
		...
		echo "
			<script type='text/javascript'>
				...
				window.location = '../crud_funcionario/consultar_funcionario.php';
			</script>
		";
	}  
	...
	//EDICAO
	function editar_funcionarios($id, $nome, $data_nascimento, $CPF, $RG, $endereco, $numero, $bairro,
	...
	function deletar_funcionarios($id){
		$conexao = Conexao::conectar();
		//SQL
