  ...
  <body >
    <nav class="navbar navbar-expand-xl navbar-dark " >
      ...
      <div class="row row-cols-1 row-cols-md-2">
        <div class="col mb-4"> 
          <div class="card">
            ...
            <div class="card-body" >
              ...
              <p class="card-text">Executa o cadastro dos pacientes, por meio de seus dados, a esse tipo de leito.</p>
            </div>
            <div class="button">
        ...
        <div class="col mb-4">
          <div class="card">
            <img src="../iclinic/imgs/consulta_clinico.jpeg" class="card-img-top" alt="...">
            <div class="card-body" >
              <h5 class="card-title">Consultar Leitos</h5>
              <p class="card-text">Uma melhor observação de como está a disposição de desses leitos.</p>
            </div>
            <div class="button">
      ...
      function cadastrar(){
        window.location.href="../iclinic/crud_leito_cli/adicionar_leito_clinico.php";
      }
      function consultar(){
        window.location.href="../iclinic/crud_leito_cli/consultar_leito_clinico.php";
      }
      </script>
