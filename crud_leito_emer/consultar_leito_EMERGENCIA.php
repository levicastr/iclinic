<?php
  ...
  if(isset($login_cookie)){
	...
	//
	$todos = $a-> listar_leito_emergencia();
			...
			echo "
				<tr>
					...
					<td class='text-center'>
						<a href='editar_leito_emergencia.php?id=".$leito['id']."'>Editar</a>
            <a href='adicionar_leito_emergencia.php?id=".$leito['id']."'>Cadastrar novo</a>
					</td>
				</tr>
			";
		}
