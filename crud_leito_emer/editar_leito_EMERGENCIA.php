<?php
	...
	@$todos = $a->leito_emergencia_por_id($id);
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<body>
   <div id="page-create-point">
    <div class="content">
	   ...
	   <form method="post" action="editar_leito_emergencia.php">
       <h1>Editar Leito</h1>
	   <fieldset>
	   <legend>
...
<?php
	...
	<div class="field-group">
        ...
        <div class="field">
            ...
            <input type="date" name="data_saida" id="bairro" maxlength="120" value="<?= $leito['data_saida'] ?>" required>
        </div>
    </div>
	</tr>
	<br>
...
<?php 
	...
	if($id != ''){
		$a->editar_leito_emergencia($id,$nome,$CPF,$RG,$data_entrada,$data_saida);
	}
?>
