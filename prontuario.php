...
<html lang="pt-br" >
  <head>
    ...
    <title>Prontuário Iclinic</title>
    <!-- Bootstrap core CSS -->
  ...
  <body >
    <nav class="navbar navbar-expand-xl navbar-dark ">
      ...
      <div class="row row-cols-1 row-cols-md-2">
        <div class="col mb-4"> 
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Inserir Prontuário</h5>
              <p class="card-text">Ao clicar será direcionado para página de cadastro</p>
            </div>
            <div class="button">
                <button  onclick="cadastra()"  type="button" class="btn btn-success" id="consul">Inserir Prontuário</button>
              </div>
          </div>
        </div>
        <div class="col mb-4">
          <div class="card">
            ...
            <div class="card-body" >
              <h5 class="card-title">Consultar Prontuários</h5>
              <p class="card-text">Você terá acesso aos prontuários cadastrados no sistema. </p>
            </div>
            <div class="button">
                <button  onclick="consultar()"  type="button" class="btn btn-success" id="consul">Consultar Prontuários</button>
              </div>
          </div>
        </div>
      </div>
      ...
      function cadastra(){
        window.location.href="../iclinic/crud_prontuario/adicionar_prontuario.php";
      }
      function consultar(){
        window.location.href="../iclinic/crud_prontuario/consultar_prontuario.php";
      }
      </script>
